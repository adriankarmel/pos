	...
	<body id="page-top">	
			...
			<form:form action="search" method="POST" class="text-black-50">					
				<div class="container">				
					<div class="row">
						<div class="col">
							<h3 class="text-info">List Categories
								<button type="button" class="btn btn-outline-light text-dark" onclick="location.href='new'; return false;" title="Add Category">+</button>
							</h3>
						</div>	
					</div>										
				...
				<table class="table table-hover">
				  ...
				  <c:forEach var="tempCategory" items="${categories}">
						...
						<tr>
					      ...
					      <td><a href="${updateLink}">${tempCategory.name}</a></td>
					      <td>
					      		<a href="${deleteLink}" onclick="if (!(confirm('Are you sure you want to delete this Category? ${tempCategory.name}'))) return false">
